...
- A Vercel account. If you do not have one, you can [sign up for free](https://vercel.com/signup).
- A Vercel project. If you do not have one, you can [create a new project](https://vercel.com/new).
- The Vercel CLI installed. If you do not have it, you can install it using the following command:
...
> **Note:** This package is available for the following frameworks: Next.js, Next.js App Router, SvelteKit, Remix, Create React App, Nuxt, Vue, Astro, and other frameworks.
...
The `Analytics` component is a wrapper around the tracking script, offering more seamless integration with Vue. Route support is automatically enabled if you are using `vue-router`.
...
If you have not already, we also recommend [connecting your project's Git repository](/docs/git#deploying-a-git-repository), which will enable Vercel to deploy your latest commits to main without terminal commands.
...
After a few days of visitors, you will be able to start exploring your data by viewing and filtering the panels.
